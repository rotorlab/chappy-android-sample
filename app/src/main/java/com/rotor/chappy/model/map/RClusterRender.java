...
public class RClusterRender<T extends ClusterItem> implements ClusterRenderer<T> {
    ...
    public RClusterRender(Context context, GoogleMap map, ClusterManager<T> clusterManager) {
        mMap = map;
        mAnimate = true;
    ...
    /**
     * Transforms the current view (represented by RClusterRender.mClusters and RClusterRender.mZoom) to a
    ...
    private class RenderTask implements Runnable {
        ...
        public void run() {
            ...
            mMarkers = newMarkers;
            RClusterRender.this.mClusters = clusters;
            mZoom = zoom;
